...
class TontidAdmin {
    ...
    public function __construct() {
        ...
        add_action( 'admin_post_tontid_add_booking', 'tontid_handle_add_booking');
    }
...
public function registerAdminMenus() {
    ...
    add_submenu_page(
        'tontid',                     // Parent slug
        'Hantera bokning',             // Sidtitel
        'Hantera bokning',             // Menynamn
        'manage_options',             // Capability
        'tontid-handle-bookings',         // Slug
        array( $this, 'displayHandleBookingPage' ) // Callback
    );
...
------------------------------------------------------------------------------------*/
public function displayHandleBookingPage() {
    $this->displayAddBooking();
    $this->displayRemoveBooking();
    $this->displayAllBookings();
}



public function displayAddBooking(){
    global $wpdb;
...
public function displayRemoveBooking(){
    echo '<h1>Ta bort bokning</h1>';
    echo '<p>Detta är en placeholdertext</p>';
} 

public function displayAllBookings(){
    echo '<h1>Visa alla bokningar</h1>';
    echo '<p>Detta är en placeholdertext</p>';
}

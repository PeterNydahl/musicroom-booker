...
class AdminShowShedule{
    public function __construct(){
        add_action('admin_menu', array($this, 'add_show_schedule'));
    ...
    *************************************************************************************/
    public function add_show_schedule(){
        add_submenu_page(
        'tontid',                  // Parent slug
        ...
        array( $this, 'display_show_schedule' ) // Callback
        );     
    }

    public function display_show_schedule(){
        $this->display_week_and_room_selector();
        // Kolla om användaren bett om att visa schemat
